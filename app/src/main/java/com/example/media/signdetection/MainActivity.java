package com.example.media.signdetection;
...
import com.example.media.signdetection.ui.dashboard.DashboardFragment;
import com.example.media.signdetection.ui.dashboard.Select;
import com.example.media.signdetection.ui.env.ImageUtils;
import com.example.media.signdetection.ui.env.Logger;
//import com.example.media.signdetection.ui.home.HomeFragment;
import com.example.media.signdetection.ui.tflite.Classifier.Device;
import com.example.media.signdetection.ui.tflite.Classifier.Recognition;
    ...
    protected void showResultsInBottomSheet(List<Recognition> results) {
        if (results != null && results.size() >= 3) {
            ...
            if (recognition5 != null) {
                if (recognition5.getTitle() != null) recognition5TextView.setText(recognition5.getTitle());
                if (recognition5.getConfidence() != null)
                    recognition5ValueTextView.setText(
                            String.format("%.2f", (100 * recognition5.getConfidence())) );
            }
        }
    }
